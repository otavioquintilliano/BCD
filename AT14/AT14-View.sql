...
SELECT nome_cliente, data_nascimento, MONTH(data_nascimento) AS mes_nascimento
FROM tb_cliente;
...
SELECT nome_cliente , data_nascimento AS mes_nascimento
